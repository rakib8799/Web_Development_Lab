...
function validatePassword() {
    ...
    if(!password.match(/^.{8,20}\S$/)){
        innerHtml(passwordErr,"Invalid password");
        return false;
    }
...
function validateConfirmPassword() {
    ...
    if(!confirm_password.match(/^.{8,20}\S$/)){
...
function formData(){
    if(!validateName() || !validateUsername() || !validateEmail() || !validatePassword() || !validateConfirmPassword() || !validateContact())
        return false;
    else return true;
}
